...
function ActCheckIn () {
    ...
    return (
        <>
            ...
            <Container fluid>
                <h2 className='m-3'>
                    <i className="bi bi-geo-alt"></i> การ Check-in เพื่อเข้าร่วมการกิจกรรมพัฒนานักศึกษา
                </h2>
                ...
                <div className='p-3'>
                {
                    ...
                    <Card border="success text-success" style={{ width: '100%' }}>
                        <Card.Header><i className="bi bi-check-circle"></i> คุณสามารถ Check-in เข้าร่วมกิจกรรมได้ กรุณากดปุ่ม Check-in</Card.Header>
                        <Card.Body>
                            <Card.Title><i className="bi bi-bookmark-check"></i> หัวข้อกิจกรรม &quot;{actData.title}&quot;</Card.Title>
                            <Card.Text className='row justify-content-center mx-auto'>
                        { attLogs ? (
                            <Button variant="primary" className='m-3 col-4' onClick={handleAttLogs}><i className="bi bi-patch-check"></i> ยืนยันการเข้าร่วมกิจกรรม</Button> ) : (
                            <Button variant="secondary" className='m-3 col-4' disabled><i className="bi bi-geo-alt"></i> คุณ Check-in ในกิจกรรมนี้สำเร็จแล้ว</Button>
                        )
                        }
                            </Card.Text>
                        </Card.Body>
                    ...
                    <Card border="danger text-danger" style={{ width: '100%' }}>
                        <Card.Header>
                          <i className="bi bi-x-circle"></i> คุณไม่สามารถ Check-in เข้าร่วมกิจกรรมได้</Card.Header>
                        <Card.Body>
                            <Card.Title><i className="bi bi-bookmark-check"></i>  หัวข้อกิจกรรม &quot;{actData.title}&quot;</Card.Title>
