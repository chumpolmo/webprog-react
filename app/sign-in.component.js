      ...
      <Container fluid>
        <div className='text-center m-5'>
        {
          user ? (
            ...
            <div>
              <h2 className='m-3'>
                <i className="bi bi-house-check-fill"></i> ระบบลงทะเบียนเข้าร่วมกิจกรรมพัฒนานักศึกษาวิทยาลัยชุมชน<br />
              ...
              <Button variant="primary" onClick={signInWithGoogle} className='m-3'>
                <i className="bi bi-box-arrow-in-right"></i> ลงชื่อเข้าใช้งานด้วย Google Account
              </Button>
            </div>
          )
        }
